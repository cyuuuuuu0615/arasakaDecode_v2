...
public class BlueTeamTracker extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // 設定為藍隊管道 0 (檢測 24 號 AprilTag)
        limelight.pipelineSwitch(0);
        panServo.setPosition(SERVO_CENTER);

        telemetry.addData("隊伍", "🔵 藍隊");
        telemetry.addData("目標 AprilTag", "24 號");
        telemetry.addData("管道", "0 - blueAprilTag");
    ...
    private void trackStable() {
        ...
        if (llResult != null && llResult.isValid()) {
            ...
            telemetry.addData("隊伍", "🔵 藍隊 - 追蹤 24 號");
            ...
            telemetry.addData("隊伍", "🔵 藍隊");
            telemetry.addData("狀態", "❌ 未找到 24 號 AprilTag");
            stableCount = 0;
        }
