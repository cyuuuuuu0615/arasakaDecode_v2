...
public class teleop_v2 extends LinearOpMode {
    ...
    // 每次迴圈降低的 RPM 值。
    // Auto模式用0.4，但在TeleOp loop極快的情況下，建議用 3.0~5.0，否則降速會像蝸牛一樣慢
    ...
    // 這裡改名為 desiredTargetRpm 以避免混淆，代表"我們想要達到的目標"
    ...
    public void runOpMode() {
        ...
        telemetry.addData("Status", "Ready (Ramp Down Logic Added)");
        telemetry.update();
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Commanded RPM", "%.0f RPM", currentCommandedRpm); // 顯示當前緩降值
