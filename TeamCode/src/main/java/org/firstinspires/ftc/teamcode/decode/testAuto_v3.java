...
public class testAuto_v3 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("Ready: AUTO V9 (INTAKE ALWAYS ON / NO GATES)");
        telemetry.update();
        ...
        // [修改] 讓這個 Action 變成空執行，不關閉 Intake，不控制 Gate
        Action cmdStopIntake = packet -> {
            // robot.intakeMotor.setPower(0); // 移除
