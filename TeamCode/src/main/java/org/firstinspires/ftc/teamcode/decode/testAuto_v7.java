...
//                currentFillStep = 0;
//                Arrays.fill(testAuto_v7.actualBallSlots, BallColor.NONE);
//                initialized = true;
//            }
//
...
//                                    testAuto_v7.actualBallSlots[currentFillStep] = tempDetectedColor;
//                                } else {
//                                    testAuto_v7.actualBallSlots[currentFillStep] = confirmed;
//                                }
//                            }
//                            moveToNextPos();
//                            timer = System.currentTimeMillis();
...
//            switch (state) {
//                case DECIDE:
//                    if (sequenceIndex >= 3 || sequenceIndex >= testAuto_v7.targetSequence.size()) {
//                        state = State.STOP;
//                        break;
//                    }
//
...
//            if (testAuto_v7.actualBallSlots[2] != BallColor.NONE) return "C";
//            if (testAuto_v7.actualBallSlots[1] != BallColor.NONE) return "B";
//            if (testAuto_v7.actualBallSlots[0] != BallColor.NONE) return "A";
//            return null;
//        }
//
//        private void removeBallFromSlot(String slot) {
