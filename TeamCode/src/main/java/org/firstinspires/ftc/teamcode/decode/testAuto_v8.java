...
//public class testAuto_v8 extends LinearOpMode { // 已修改類別名稱
//
...
//                                .strafeTo(new Vector2d(-27, 35), slowVel, slowAccel)
//
...
//
//        // --- 速度設定更新 ---
//        private static final double POWER_1 = 0.5;   // 第一顆
//        private static final double POWER_2 = 0.55;  // 第二顆
//        private static final double POWER_3 = 0.55;  // 第三顆
//
//        // 固定角度常數
...
//                // 初始化
//                step = 0;
//                currentPower = POWER_1; // 設定初始速度為 0.5
//                angleServo.setPosition(FIXED_ANGLE); // 固定角度 0.2
...
//                        currentPower = POWER_1; // 0.5
//                    } else if (step == 1) {
//                        targetPos = FIRE_POS_B;
//                        currentPower = POWER_2; // 0.55
//                    } else { // step == 2
//                        targetPos = FIRE_POS_A;
//                        currentPower = POWER_3; // 0.55
//                    }
//
//                    // 再次確保角度固定
...
//        private static final int TIME_BALL_SETTLE = 80;
...
//                currentFillStep = 0;
//                Arrays.fill(testAuto_v8.actualBallSlots, BallColor.NONE); // 已修改
//                initialized = true;
//            }
//
...
//                                    testAuto_v8.actualBallSlots[currentFillStep] = tempDetectedColor; // 已修改
//                                } else {
//                                    testAuto_v8.actualBallSlots[currentFillStep] = confirmed; // 已修改
//                                }
//                            }
//                            moveToNextPos();
//                            timer = System.currentTimeMillis();
...
//
//        // 速度常數
//        private static final double POWER_1 = 0.7;
//        private static final double POWER_2 = 0.75;
//        private static final double POWER_3 = 0.8;
//
//        // 固定角度常數
//        private static final double FIXED_ANGLE = 0.2;
//
...
//            switch (state) {
//                case DECIDE:
//                    if (sequenceIndex >= 3 || sequenceIndex >= testAuto_v8.targetSequence.size()) { // 已修改
//                        state = State.STOP;
//                        break;
//                    }
//
...
//                    angleServo.setPosition(FIXED_ANGLE);
//
//                    BallColor neededColor = testAuto_v8.targetSequence.get(sequenceIndex); // 已修改
...
//            if (testAuto_v8.actualBallSlots[2] != BallColor.NONE) return "C"; // 已修改
//            if (testAuto_v8.actualBallSlots[1] != BallColor.NONE) return "B"; // 已修改
//            if (testAuto_v8.actualBallSlots[0] != BallColor.NONE) return "A"; // 已修改
//            return null;
//        }
//
//        private void removeBallFromSlot(String slot) {
//            if (slot.equals("A")) testAuto_v8.actualBallSlots[0] = BallColor.NONE; // 已修改
//            else if (slot.equals("B")) testAuto_v8.actualBallSlots[1] = BallColor.NONE; // 已修改
//            else if (testAuto_v8.actualBallSlots.length > 2 && slot.equals("C")) testAuto_v8.actualBallSlots[2] = BallColor.NONE; // 已修改
//        }
//    }
//
//    // =========================================================
